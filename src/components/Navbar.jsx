...
const Navbar = () => {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/mst-borsha", label: "GitHub" },
    { icon: Mail, href: "https://mail.google.com/mail/?view=cm&fs=1&to=mstborsha852005@gmail.com", label: "Email" },
  ];
