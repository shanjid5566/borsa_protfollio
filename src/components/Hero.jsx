...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-gray-50 to-primary-50 dark:from-dark-900 dark:via-dark-900 dark:to-dark-800 pt-20"
    >
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-left">
              ...
              >
                WordPress Developer with 6+ months of hands-on professional
                experience, successfully delivering 30+ live projects with
                satisfied clients. Experienced in Crocoblock, capable of
                handling multiple projects simultaneously, and committed to
                creating high-quality, responsive, and user-friendly websites on
                time. Strong problem-solving skills and a proven ability to meet
              ...
              >
                <a
                  href="#projects"
                  className="btn-primary group inline-flex items-center gap-2 whitespace-nowrap"
                >
